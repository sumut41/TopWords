...
interface CourseWordDao {
    ...
    @Query("UPDATE ${RoomDatabaseConstant.COURSE_WORD_TABLE} SET isStart = :isStart, progress = :progress, isCompleted = :isComplete where id = :id")
    suspend fun updateCourse(id: Long, isStart: Boolean, progress: Float, isComplete: Boolean)
